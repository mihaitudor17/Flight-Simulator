...
Model* Tower = nullptr;
Model* Hangar = nullptr;
Model* Cessna = nullptr;
...
void RenderScene(const Shader* shader)
{
    ...
    model = glm::scale(model, { 30.0f, 30.0f, 30.0f });
    ...
    model = glm::mat4(1.0f);
    model = glm::translate(model, {66.0f, -0.5f, 0.0f});
    ...
    model = glm::mat4(1.0f);
    model = glm::translate(model, { 66.0f, -0.5f, -50.0f });
    model = glm::scale(model, { 3.0f, 3.0f, 3.0f });
    model = glm::rotate(model, glm::radians(90.0f), { 0.0f, 0.0f, 1.0f });
    model = glm::rotate(model, glm::radians(90.0f), { 0.0f, 1.0f, 0.0f });
    shader->SetMat4("model", model);
